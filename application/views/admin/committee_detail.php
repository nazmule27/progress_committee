...
<div class="col-md-9 col-sm-8 col-xs-12">
    ...
    <p>
        ...
        <a target="_blank" class="btn btn-default pull-right" href="<?=base_url();?>committee/committee_print/<?php echo $committee[0]->id; ?>"><i class="glyphicon glyphicon-print"></i> Print</a>
    </p>
